...
<div class="loader">
   ...
   <div id="why-zeina  blog" class="block btn-special team h-100 mt-xl-4 wow bounceInDown " data-wow-duration="2s" data-wow-delay="50ms">
    <div class="container">
        <h2 class="text-success text-center line-center pb-2">قصص النجاح</h2>
                ...
                <article class="entry-box-1 mb-4 bg-primary shadow-sm h-100">
                    ...
                    <div class="entry-body p-3 pb-1">
                        ...
                        <div class="col-auto  my-auto  d-flex justify-content-end more ">
                            <a href="blog-details-story-9.php"><button class=" btn-outline  mb-1 mb-md-0">شاهد المزيد</button></a>
                        </div>
                    </div>
