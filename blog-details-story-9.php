...
<div class="loader">
    <div class="lds-ellipsis"><div></div><div></div><div></div><div></div></div>
         ...
         <div id=" blog" class=" blog h-100  wow bounceInDown " data-wow-duration="2s" data-wow-delay="50ms">

                 <div class="swiper-container mb-5">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                          <div class="item img-fluid " style="background-image: url('./assets/images/sign.jpg')"></div>
                        <div class="new-box">
                    ...
                    <div class="swiper-slide">
                        <div class="item img-fluid " style="background-image: url('./uploads/Ad1.jpg')"></div>
                        <div class="new-box">
                            <div class="new  bg-success text-white py-4  font-weight-bold  ">
                                جديد
                            </div>
                ...
                <div class="blog-details">
                    ...
                    <div class="row  container d-flex justify-content-between mb-4" style='padding-left:0;'>
                        <div class="head-details">
                            <h3 class="font-weight-bold text-success mb-3">عنوان قصه النجاح</h3>
                        </div>
                        ...
                        <div class='mb-4'>
                            <video width="100%" height="300" controls>
                              ...
                              <source src="assets/images/mov_bbb.mp4" type="video/ogg">
                             </video>
                        </div>
